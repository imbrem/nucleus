---
name: change-logic
description: Evolve Nucleus checked logic across Rust, Lean, wire encodings, WIT, bindings, and fixtures. Use when changing a logical constructor or rule, an arena row or tag, theorem authority, imports, canonical encoding, or a public kernel capability.
---

# Change logic

1. Locate the checked authority boundary and its nearest module documentation.
   Distinguish raw syntax, checked facts, userspace derivation, and provenance.
