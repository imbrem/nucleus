...
private def field (key : String) (value : Json) (tail : RawSyn Scalar JsonIx.obj) :
    RawSyn Scalar JsonIx.obj := .objCons key value tail

private def tagged (schema : Schema) (tag : String)
    (fields : RawSyn Scalar JsonIx.obj := .objNil) : Json :=
