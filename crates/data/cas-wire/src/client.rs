...
/// Separate read and write halves carrying the CAS protocol.
...
/// A remote CAS with serialized request/response exchange.
...
/// An object held open by the server until dropped.
