...
An `O256` is written as `!` followed immediately by exactly 64 lowercase
hexadecimal digits, with no brackets. It is stored as the typed `O256` value
rather than retained as text.
