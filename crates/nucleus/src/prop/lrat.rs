//! Bounded LRAT decoding and an instruction-driven clause kernel.
//!
//! Only initial clauses and checked learned clauses enter [`LratKernel`].
...
/// Parses ASCII or binary LRAT under explicit allocation bounds.
///
/// # Errors
///
