...
use covalence_nucleus_script::{InitSlice, compile_init_slice};
...
Generated by the untrusted `covalence-nucleus-script` userspace frontend.\n\
...
-- The generated byte literal is intentionally large and checked without a fixed reduction budget.\n\
