...
class MemoryCas:
    """A relation-style userspace CAS with checked fact storage."""

    limit: int
    facts: list[CasFact]

    def __init__(self, limit: int | None = None) -> None: ...
    def put(self, blob: Buffer, /) -> CasFact: ...
    def insert(self, fact: CasFact, /) -> bool: ...
    def get(self, address: O256, /) -> CasFact: ...
    def contains(self, address: O256, /) -> bool: ...
    def remove(self, address: O256, /) -> bool: ...
    def __len__(self) -> int: ...

def get_exact(provider: object, address: O256, /) -> CasFact: ...
