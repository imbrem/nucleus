...
class Diagram:
    ...
    @staticmethod
    def constant(value: bool, /) -> Diagram: ...
    @staticmethod
    def branch(variable_number: int, low: Diagram, high: Diagram, /) -> Diagram: ...
...
class BddManager:
    ...
    def variable(self, variable_number: int, /) -> Bdd: ...
    def reduce(self, diagram: Diagram, /) -> Bdd: ...
    def from_cnf(self, formula: Formula, /) -> Bdd: ...
...
class Bdd:
    ...
    def implies(self, conclusion: Bdd, /) -> Bdd: ...
    def equivalent(self, other: Bdd, /) -> Bdd: ...
    def if_then_else(self, then_value: Bdd, else_value: Bdd, /) -> Bdd: ...
    def exists(self, variable_number: int, /) -> Bdd: ...
    def evaluate(self, assignment: dict[int, bool], /) -> bool: ...
    def to_diagram(self) -> Diagram: ...
    def to_cnf(self) -> CnfEncoding: ...
    def __and__(self, other: Bdd, /) -> Bdd: ...
    def __rand__(self, other: Bdd, /) -> Bdd: ...
    def __or__(self, other: Bdd, /) -> Bdd: ...
    def __ror__(self, other: Bdd, /) -> Bdd: ...
    def __xor__(self, other: Bdd, /) -> Bdd: ...
    def __rxor__(self, other: Bdd, /) -> Bdd: ...
...
class CnfEncoding:
    """A Tseitin CNF and its fresh auxiliary variables."""

    formula: Formula
    introduced_variables: list[int]
