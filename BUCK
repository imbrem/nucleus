...
genrule(
    ...
    srcs = named_sources({
        ...
        "data-sqlite": "//crates/data/sqlite:package_files",
    ...
    srcs = named_sources(
        {
            ...
            "lib-sqlite": "//crates/lib/sqlite:package_files",
            "logic-cas": "//crates/logic/cas:package_files",
            "logic-classical": "//crates/logic/classical:package_files",
            "logic-hol": "//crates/logic/hol:package_files",
            "logic-lrat": "//crates/logic/lrat:package_files",
            "logic-sat": "//crates/logic/sat:package_files",
            "data-sqlite": "//crates/data/sqlite:package_files",
            "nucleus": "//crates/nucleus:package_files",
